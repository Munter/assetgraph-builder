...
function assetNeedsLocalization(asset, assetGraph) {
    ...
    if (asset.type === 'JavaScript') {
        ...
        AssetGraph.assets.Css.eachRuleInParseTree(asset.parseTree, function (cssRule, parentRuleOrStylesheet) {
            ...
            localeIds.forEach(function (localeId) {
                ...
                function localizeAsset(asset) {
                    if (asset.type === 'JavaScript') {
                        ...
                        var cssRules = [];
                        AssetGraph.assets.Css.eachRuleInParseTree(asset.parseTree, function (cssRule) {
                            if (cssRule.type === 1) { // cssom.CSSRule.STYLE_RULE

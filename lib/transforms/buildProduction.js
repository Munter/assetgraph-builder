    ...
    return function buildProduction(assetGraph, cb) {
        ...
        assetGraph
            ...
            .if(options.manifest)
                ...
                .endif()
            .endif()
            .moveAssetsInOrder({isLoaded: true, isInitial: query.not(true), isInline: false, type: query.not('CacheManifest')}, function (asset, assetGraph) {
                ...
                if (options.cdnRoot && asset.type !== 'Htc' && (asset.isImage || asset.type === 'Flash' || assetGraph.findRelations({to: asset, type: 'StaticUrlMapEntry'}).length === 0)) {
